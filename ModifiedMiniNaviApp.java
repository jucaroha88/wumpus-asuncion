 ...
 */
public class ModifiedMiniNaviApp implements ActionListener {
	...
	protected BidirectionalAStarRouteCalculator routeCalculator;
	...
	public ModifiedMiniNaviApp(String[] args) {
		initFrame(args);
	...
	public static void main(String[] args) {
		...
		ModifiedMiniNaviApp demo = new ModifiedMiniNaviApp(args);
