 ...
 */
public class AStarBidirectionalSearch implements Search {
...
class CachedStatePriorityQueue<E> extends PriorityQueue<E> {
	private static final long serialVersionUID = 1;
	private Map<Object, Node> cachedState = new HashMap<Object, Node>();

	public CachedStatePriorityQueue() {
		super();
	}

	public CachedStatePriorityQueue(Collection<? extends E> c) {
		super(c);
	}

	public CachedStatePriorityQueue(int initialCapacity,
	...
	public CachedStatePriorityQueue(PriorityQueue<? extends E> c) {
		super(c);
	}

	public CachedStatePriorityQueue(SortedSet<? extends E> c) {
		super(c);
	}
